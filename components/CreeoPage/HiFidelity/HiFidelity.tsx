      ...
      <div className={classes.stages}>
        <div className={classes.stage}>
          <div className={classes.left}>
            <div className={classes.topic}>Hi-fidelity <br />Designs</div>
          </div>
          <div className={classes.text}>
            During this phase, I designed with a high level of detail and realism ensuring visual consistency and optimizing the interface and interactions to support the core functionalities. As an additional challenge, I decided to design the web app to have a look and feel of a native application that users are already familiar with.            </div>
        </div>
        <div className={classes.fidelityContainer}>
          <div className={`${classes.fidelity} ${classes._1}`}>
            <Image src={fidelity1} alt="" />
            <div className={classes.textContainer}>
              <div className={classes.title}>Making it easy to generate NFTs</div>
              <div className={classes.text}>Helping new users get familiar with the UI by providing virtual tour, and resources.</div>
          ...
          <div className={`${classes.fidelity} ${classes._2}`}>
            <div className={classes.textContainer}>
              ...
              <div className={classes.text}>Users can upload all their art layers on the app with one single click</div>
              <div className={classes.playContainer}>
                <PlayIcon />
                <div>Play</div>
              </div>
          ...
          <div className={classes.wrapper}>
            <div className={`${classes.fidelity} ${classes._3}`}>
              <div className={classes.textContainer}>
                ...
                <div className={classes.text}>Search and filter to help users select and filter through traits easily.</div>
                <div className={classes.playContainer}>
                  <PlayIcon />
                  <div>Play</div>
                </div>
        ...
        <div className={classes.fidelity_2}>
          <div className={classes.innerF}>
            ...
            <div className={classes.text}>Rules to help users seamlessly control what traits can be combined with another and how often.</div>
          </div>
          <div className={classes.innerF}>
            <Image src={fidelity5} alt="" />
            <div className={classes.text}>One click to start contract deployment to the blockchain after generating artworks.</div>
          </div>
        </div>
