  ...
  return (
    <div className={classes.container}>
      ...
      <div className={classes.description}>
        Hi there! I’m Buchi, <span>a product designer</span>, snooker magician,
        fashion lover, and a dang skillful soccer player.{" "}
      </div>
        ...
        <div>
          <div className={classes.textContainer}>
            ...
            <div className={classes.text}>
              ...
              <span>Bleuwater</span>. I led all of Bleuwater design output. From
              digital products, to marketing visuals. I have also freelanced for
              several startups <span>Genadrop</span>, assisting them in
              developing their initial product offering.
            </div>
            <div className={classes.text}>
              Currently on the market for new opportunities. Got a project idea
              on your mind? Or perhaps you need a creative and devoted product
              designer for your team? I’m one email away from building with you.
            </div>
            <div className={classes.text}>
              I’m always eager to contribute to team success through hard work,
              attention to details, and excellent organizational skills.
              Motivated to learn, grow and excel in UX Design.
            </div>
          </div>
