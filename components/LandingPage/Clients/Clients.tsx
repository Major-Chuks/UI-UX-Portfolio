  ...
  return (
    <div className={classes.container}>
      ...
      <div className={classes.description}>
        <div>I have worked for different startups, helping them launch their MVPs</div>
      </div>
      ...
      <div className={classes.sticky}>Based in Nigeria, Available worldwide</div>
      <div className={classes.salutation}>
        <div className={classes.text}>Happy to work with you, send a message</div>
